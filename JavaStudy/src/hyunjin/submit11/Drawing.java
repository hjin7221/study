...
public class Drawing {
	...
	public Drawing(String title, String content) {
		...
		if (temp[0].contains("Ford") ||temp[0].contains ("ISUZU") ||temp[0].contains( "FCA") ||temp[0].contains( "RSA")||temp[0].contains( "Volvo") ) {
			this.division = "자동차";
		}else if(temp[0].contains("JH")||temp[0].contains("JP")||temp[0].contains("Omron")||temp[0].contains("Gen")) {
			this.division = "E S S";
		}else {
			this.division = "e t c.";
		}
	...
	public Drawing(int no, String title, String content) {
		...
		String[] temp = title.split("_");
		this.no = no;
		if (temp[0].contains("Ford") ||temp[0].contains ("ISUZU") ||temp[0].contains( "Chrysler") ||temp[0].contains( "RSA")||temp[0].contains( "Volvo") ) {
			this.division = "자동차";
		}else if(temp[0].contains("JH")||temp[0].contains("JP")||temp[0].contains("Omron")||temp[0].contains("Gen")) {
			this.division = "E S S";
		}else {
