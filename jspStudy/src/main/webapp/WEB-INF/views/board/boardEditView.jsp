                    ...
                    <div class="col-lg-8 col-xl-7">
                        <form id="contactForm" action="<c:url value='/boardEditDo'/>" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="title" name="boardTitle" type="text" value="${board.boardTitle }" placeholder="Enter title..." />
                            ...
                            <!-- content input-->
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="message" name="boardContent" type="text"  placeholder="Enter your message here..." style="height: 20rem">${board.boardContent }</textarea>
