                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        <form id="contactForm" action="<c:url value='/memberEditDo'/>" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="id" name="memId" type="text" placeholder="Enter your ID..." readonly value="${sessionScope.login.memId }"/>
                            ...
                            <!-- Name input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" name="memName" type="text" placeholder="Enter your Name..." value="${sessionScope.login.memName }"/>
                    ...
                    <div class="col-lg-8 col-xl-7 d-flex justify-content-center">
                    	<form id="contactForm" action="<c:url value='/memberDelDo'/>" method="POST">
                    		<button class="btn btn-danger btn-xl" id="submitButton" type="submit">삭제하기</button>
                    	</form>
                    </div>
                </div>
            </div>
